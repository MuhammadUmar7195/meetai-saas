...
const DashboardUserButton = () => {
    ...
    if (isMobile) {
        return <>
            <Drawer>
                <DrawerTrigger className="flex rounded-lg border border-border/10 p-3 w-full flex-items-center justify-between bg-white/5 hover:bg-white/10 overflow-hidden gap-x-2">
                    {data?.user?.image ? (
                        <Avatar className="">
                            <AvatarImage
                                src={data.user.image}
                ...
                <DrawerContent>
                    ...
                    <DrawerFooter>
                        ...
                        <Button variant="outline" onClick={onLogout}>
                            <TbLogout className="size-4 ml-2" />
                            Logout
                        </Button>
                    </DrawerFooter>
                </DrawerContent>
