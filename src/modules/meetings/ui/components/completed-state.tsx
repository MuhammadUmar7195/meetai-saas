...
import { BookOpenIcon, ClockFadingIcon, FileTextIcon, FileVideoIcon, SparkleIcon, SparklesIcon } from "lucide-react";
    ...
    return (
        <div className="flex flex-col gap-y-4">
            <Tabs defaultValue="summary">
                ...
                {/* This recording retains in two week and then it will delete
                Alternate solution is that use cloud storages for this purpose */}
