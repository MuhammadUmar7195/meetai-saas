    ...
    "rounded-lg p-4 py-6 w-full",
    {
        variants: {
            variant: {
                ...
                highlighted: "bg-linear-to-br from-[#093C23] to-[#051B16] text-white shadow-lg",
            },
        },
        defaultVariants: {
            variant: "default",
...
export const pricingCardIconVariants = cva(
    "size-5",
    {
        variants: {
            variant: {
...
export const pricingCardSecondaryTextVariants = cva(
    "text-neutral-700",
    {
        variants: {
            variant: {
...
export const pricingCardBadgeVariants = cva(
