...
export const premiumProtectedProcedure = (entity: "meetings" | "agents") => {
  return protectedProcedure.use(async ({ ctx, next }) => {
    ...
    if(shouldThrowMeetingError){
      throw new TRPCError({
        code: "FORBIDDEN",
        message: "You have exceeded the free meeting limit."
      })
    }
    ...
    if(shouldThrowAgentError){
      throw new TRPCError({
        code: "FORBIDDEN",
        message: "You have exceeded the free agent limit."
      })
    }
